...
int main(int argc,char *argv[])
{
    ...
    if(!pipeline || !v4l2src || !videoconvert || !tee || !queue1
    ...
    gst_bin_add_many (GST_BIN(pipeline) , v4l2src , videoconvert , tee , queue1 ,
     queue2 , x264enc , rtph264pay , ximagesink , rtmpsink , NULL);
    ...
    gst_element_link_many(queue1 , x264enc , rtph264pay , NULL) != TRUE ||
    gst_element_link_many(queue2 , ximagesink , NULL) != TRUE)
    {
